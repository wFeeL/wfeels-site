 ...
 * заранее. Остальные строки этой таблицы решение не задевает: на 1180/1440
 * без полосы дельта раздела 15 равна 0 (юридический ряд уже собран в строку),
 * а на 390/768 без полосы и на 768 с полосой прежний запас ~7% дельту
 * покрывает без правки числа — измерено при том же прогоне. */
