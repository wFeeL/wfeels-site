...
/* Точка перелома рельса — 1204 px, посчитана в `tokens.css`/`Rail.astro`, а не
...
/* Широкий экран для тестов, которым важна не сама точка перелома, а факт, что
   ...
   (1204 px), не завязанное на его точное значение: сдвинь порог завтра ещё
 ...
 * рельса не видели вовсе — теперь все они выше 1204 px, и рельс на них
