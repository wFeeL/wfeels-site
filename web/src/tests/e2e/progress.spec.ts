...
// 1324 px (владелец 2026-08-13 опустил её с 1600 px вместе с самим рельсом,
// потом контейнер вернулся 1060 → 1180 px тем же днём, и порог пересчитался),
// поэтому полоса остаётся в разметке всегда (её прячет только CSS,
