...
describe('dist/index.html — секции 1–3', () => {
  ...
  it('секция 1: четыре строки таблицы — цена и срок совпадают с данными, не с текстом теста', () => {
    const rows: Array<[string, string, string]> = [
      ...
      ['Аудит сайта', HERO_TERMS[3].term, priceFor('Сайты', 'Аудит сайта + план правок')],
    ];
