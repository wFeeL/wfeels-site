...
export const HERO_TERMS: readonly TermEntry[] = [
  {
    ...
    term: 'от 2–4 дней',
    source:
      'SERVICES.md:34 — услуга S1 «Сайт под ключ», строка «Срок: от 2–4 дней ' +
      '(шаблон) до 2–3 недель (10 страниц). От 10 000 ₽.»',
  },
  {
  ...
  },
  {
    ...
    term: 'от 3–5 дней',
    source:
      'SERVICES.md:72 — услуга S4 «ИИ-консультант по материалам бизнеса», ' +
