...
export const TOP_CARDS: readonly TopCard[] = [
  ...
  },
  {
    ...
    // Текст и место ярлыка — правка владельца 2026-08-13, часть 2 (следующий
    // коммит); здесь пока прежнее утверждённое «Советую этот вариант», без
    // отмены D-029 — сама отмена и метка «Самый популярный» вносятся в
    // отдельном коммите, чтобы commit-история отражала части брифа по
    // отдельности.
    recommended: { label: 'Советую этот вариант' },
  },
  {
