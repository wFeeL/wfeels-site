...
/** Точки рельса из спеки 02-home.md, раздел 3 — сверка построчно, а не на
 *  глаз: если кто-то передвинет секцию в другую группу, этот тест покраснеет
 *  раньше, чем рельс задачи 4 подсветит не ту точку. */
...
describe('HOME_SECTIONS — целостность списка', () => {
  ...
  it('группировка по точкам рельса совпадает со спекой', () => {
    ...
    // Никакая секция не осталась вне семи точек таблицы.
