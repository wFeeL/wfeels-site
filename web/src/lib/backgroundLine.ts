...
export const LR_TILE =
  "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 192'><path d='M0,0 C0,96 1000,96 1000,192' stroke='#000' stroke-width='2' fill='none'/></svg>";
export const RL_TILE =
  "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 192'><path d='M1000,0 C1000,96 0,96 0,192' stroke='#000' stroke-width='2' fill='none'/></svg>";
