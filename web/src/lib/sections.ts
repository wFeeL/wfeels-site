 ...
 *  контакт». Акт 3, `turn: 'none'`; после переноса нижнего маршрута
 *  `2026-08-28` фактический прямой прогон стоит на правом доке между
 *  правым выходом `about` и правым входом `faq` (`linePaths.ts`, D-149),
